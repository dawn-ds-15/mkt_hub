    ...
    <div className="flex gap-gutter max-w-container_max_width mx-auto">
      <section className="flex-1 space-y-gutter">
        <header className="flex items-center justify-between mb-stack_lg">
          <div>
            <h3 className="font-headline-md text-headline-md font-bold text-on-surface">Active Projects</h3>
            <p className="text-body-md text-on-surface-variant">Manage and track your ongoing marketing initiatives.</p>
          </div>
